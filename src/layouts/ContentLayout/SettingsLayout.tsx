...
const SettingsLayout: FC<SettingsLayoutProps> = ({ tabs }) => {
  ...
  return (
    <section className='flex flex-col w-full h-full gap-5 p-5 overflow-hidden bg-white rounded-md md:gap-0'>
      ...
      <Tabs
        ...
        className='flex flex-col items-start justify-center h-full md:flex-row '
      >
        {/* Sidebar Menu */}

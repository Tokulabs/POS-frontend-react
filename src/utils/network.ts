...
export const suppliersURL = baseURL + 'app/supplier'
export const costCenterURL = baseURL + 'app/cost-center'
...
export const supplierReportURL = baseURL + 'app/supplier-report'
export const supplierMonthlyTrendURL = baseURL + 'app/supplier-monthly-trend'
...
export const restaurantComboOptionReorderURL = (menuItemId: number, groupId: number) =>
  `${baseURL}restaurant/menu/${menuItemId}/option-groups/${groupId}/reorder-options/`
